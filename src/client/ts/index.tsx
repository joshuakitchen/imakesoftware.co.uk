  ...
  return (
    <div className='content'>
      ...
      <p>
        ...
        you exactly the kind of nutjob you're dealing with here. This will not
        be an organised website but a cacophany of chaos creating project after
        project after project which will ultimately result in none of them being
        finished and all of them being a little bit shit.
      </p>
    </div>
  )
}
